...
**Project version:** 1.20 · 2026-08-17 · under founder review
**This file last changed in:** 1.20 (the availability steps: disk sizing and DNS TTL at 5.2, restart policy and maintenance page at 5.4, the off-server backup key at 5.6, new 5.7 for job monitoring, an alarm test at 16.6, and the runbook's contents specified at 17.3)
