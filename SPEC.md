...
**This file last changed in:** 1.22 (§16: conformance put on three clocks instead of one gate, the human passes given a qualified tester, and the operator console settled as a bounded commitment)
