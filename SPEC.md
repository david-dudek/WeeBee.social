...
**This file last changed in:** 1.26 (three internal contradictions resolved: §9.1's basic-tier invariant is over the field set rather than the data source and now lists which friend-request-card fields freeze and which render live; §8.1's comment audience is the post's audience minus blocks, not "exactly" it, with §7.9 and §8.2 following; §12.3's email rule is narrowed to *relative* ages, with §7.5.1 and §4.8 following)
